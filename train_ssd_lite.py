...
from vision.datasets.deepfashion2_dataset import DeepFashion2Dataset
...
if __name__ == '__main__':
    ...
    for dataset_path in args.datasets:
        if args.dataset_type == 'voc':
            ...
            label_file = os.path.join(args.checkpoint_folder, "pascal-voc-classes.txt")
    ...
    if args.dataset_type == "voc":
        ...
        val_dataset = DeepFashionDataset(args.validation_dataset,
